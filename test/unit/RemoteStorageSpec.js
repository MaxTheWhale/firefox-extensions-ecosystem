...
describe("Google Drive", () => {
    ...
    it("Should be able to complete a download without error", async () => {
        try {
            fetchMock.get("https://www.googleapis.com/drive/v3/files/?fields=files(kind,id,mimeType,name)&q=%20%271234%27%20in%20parents%20and%20appProperties%20has%20%7Bkey=%27remoteStorage%27%20and%20value=%27https://remotestoretestredirect.url/%27%7D", { body: { files: [{ name: "downloadTest.txt", id: "1235", parents: ["1234"] }] }, status: 200 });
    ...
    it("Should be able to delete a file without error", async () => {
        try {
            fetchMock.get("https://www.googleapis.com/drive/v3/files/?fields=files(kind,id,mimeType,name)&q=%20%271234%27%20in%20parents%20and%20appProperties%20has%20%7Bkey=%27remoteStorage%27%20and%20value=%27https://remotestoretestredirect.url/%27%7D", { body: { files: [{ name: "deleteTest.txt", id: "1235", parents: ["1234"] }] }, status: 200 });
    ...
    it("Should be able to get correct file's info", async () => {
        try {
            fetchMock.get("https://www.googleapis.com/drive/v3/files/?fields=files(kind,id,mimeType,name)&q=%20%271234%27%20in%20parents%20and%20appProperties%20has%20%7Bkey=%27remoteStorage%27%20and%20value=%27https://remotestoretestredirect.url/%27%7D", { body: { files: [{ name: "infoTest1.txt", id: "1235", parents: ["1234"], mimeType: "text/plain" }] }, status: 200 });
    ...
    it ("Should be able to get all files info", async () => {
        try {
            fetchMock.get("https://www.googleapis.com/drive/v3/files/?fields=files(kind,id,mimeType,name)&q=%20%271234%27%20in%20parents%20and%20appProperties%20has%20%7Bkey=%27remoteStorage%27%20and%20value=%27https://remotestoretestredirect.url/%27%7D", { body: { files: [{ name: "infoTest2.txt", id: "1235", parents: ["1234"], mimeType: "text/plain" }] }, status: 200 });
    ...
    it("Should be able to overwrite a file", async () => {
        try {
            fetchMock.get("https://www.googleapis.com/drive/v3/files/?fields=files(kind,id,mimeType,name)&q=%20%271234%27%20in%20parents%20and%20appProperties%20has%20%7Bkey=%27remoteStorage%27%20and%20value=%27https://remotestoretestredirect.url/%27%7D", { body: { files: [{ name: "overwriteTest.txt", id: "1235", parents: ["1234"] }] }, status: 200 });
    ...
    it("Should support unicode filename download", async () => {
        try {
            fetchMock.get("https://www.googleapis.com/drive/v3/files/?fields=files(kind,id,mimeType,name)&q=%20%271234%27%20in%20parents%20and%20appProperties%20has%20%7Bkey=%27remoteStorage%27%20and%20value=%27https://remotestoretestredirect.url/%27%7D", { body: { files: [{ name: "子曰ٱلرَّحِيمِ.txt", id: "1235", parents: ["1234"] }] }, status: 200 });
